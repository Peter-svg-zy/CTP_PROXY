...
password = 'wang0612'
broker_id = '9999'
market_server_front = 'tcp://180.168.146.187:10131'
trade_server_front = 'tcp://180.168.146.187:10130'
...
def ReqorderfieldInsert(tradeapi):
	...
	orderfield.BrokerID=broker_id
	orderfield.ExchangeID=EXCHANGEID
	orderfield.InstrumentID=INSTRUMENTID
	orderfield.UserID=investorID
	orderfield.InvestorID=investorID
...
class CTradeSpi(api.CThostFtdcTraderSpi):
	...
	def OnFrontConnected(self) -> "void":
		...
		authfield.BrokerID=broker_id
		authfield.UserID=investorID
		authfield.AppID="simnow_client_test"
		authfield.AuthCode="0000000000000000"
		self.tduserapi.ReqAuthenticate(authfield,0)
	...
	def OnRspAuthenticate(self, pRspAuthenticateField: 'CThostFtdcRspAuthenticateField', pRspInfo: 'CThostFtdcRspInfoField', nRequestID: 'int', bIsLast: 'bool') -> "void":	
		...
		if not pRspInfo.ErrorID :
			...
			loginfield.BrokerID=broker_id
			loginfield.UserID=investorID
			loginfield.Password=password
			loginfield.UserProductInfo="python dll"
			self.tduserapi.ReqUserLogin(loginfield,0)
			print ("send login ok")
	...
	def OnRspUserLogin(self, pRspUserLogin: 'CThostFtdcRspUserLoginField', pRspInfo: 'CThostFtdcRspInfoField', nRequestID: 'int', bIsLast: 'bool') -> "void":
		...
		qryinfofield.BrokerID=broker_id
		qryinfofield.InvestorID=investorID
		qryinfofield.TradingDay=pRspUserLogin.TradingDay
		self.tduserapi.ReqQrySettlementInfo(qryinfofield,0)
	...
	def OnRspQrySettlementInfo(self, pSettlementInfo: 'CThostFtdcSettlementInfoField', pRspInfo: 'CThostFtdcRspInfoField', nRequestID: 'int', bIsLast: 'bool') -> "void":
		...
		pSettlementInfoConfirm.BrokerID=broker_id
		pSettlementInfoConfirm.InvestorID=investorID
		self.tduserapi.ReqSettlementInfoConfirm(pSettlementInfoConfirm,0)
